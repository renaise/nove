  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-black selection:text-white">
      ...
      <nav className={`fixed w-full top-0 z-50 transition-all duration-300 ${
        ...
        <div className="relative flex items-center justify-between px-6 py-4 lg:px-10">
          ...
          <div className="hidden md:flex items-center gap-8 absolute left-1/2 -translate-x-1/2">
            <a href="#about" className={`text-[11px] uppercase tracking-[0.2em] transition-colors duration-300 ${
              scrolled ? 'text-black/70 hover:text-black' : 'text-white/80 hover:text-white'
            }`}>About</a>
            <a href="#for-brides" className={`text-[11px] uppercase tracking-[0.2em] transition-colors duration-300 ${
              scrolled ? 'text-black/70 hover:text-black' : 'text-white/80 hover:text-white'
            }`}>For Brides</a>
            <a href="#boutiques" className={`text-[11px] uppercase tracking-[0.2em] transition-colors duration-300 ${
              scrolled ? 'text-black/70 hover:text-black' : 'text-white/80 hover:text-white'
            }`}>For Boutiques</a>
            <a href="#browse" className={`text-[11px] uppercase tracking-[0.2em] transition-colors duration-300 ${
              scrolled ? 'text-black/70 hover:text-black' : 'text-white/80 hover:text-white'
            }`}>Browse</a>
          </div>

          {/* CTA Button - COS style underline */}
          <a href="#for-brides" className={`hidden md:block text-[11px] uppercase tracking-[0.2em] transition-all duration-300 border-b ${
            scrolled
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white p-8 flex flex-col gap-6 border-t border-black/10">
            <a href="#about" onClick={() => setMobileMenuOpen(false)} className="text-[11px] uppercase tracking-[0.2em] text-black/70">About</a>
            <a href="#for-brides" onClick={() => setMobileMenuOpen(false)} className="text-[11px] uppercase tracking-[0.2em] text-black/70">For Brides</a>
            <a href="#boutiques" onClick={() => setMobileMenuOpen(false)} className="text-[11px] uppercase tracking-[0.2em] text-black/70">For Boutiques</a>
            <a href="#browse" onClick={() => setMobileMenuOpen(false)} className="text-[11px] uppercase tracking-[0.2em] text-black/70">Browse</a>
            <a href="#for-brides" onClick={() => setMobileMenuOpen(false)} className="mt-4 text-[11px] uppercase tracking-[0.2em] text-black border-b border-black/30 self-start pb-1">
              Try On
            </a>
          </div>
        )}
      ...
      <section className="relative min-h-screen flex flex-col justify-end">
        ...
        {/* Content at Bottom - COS minimal style */}
        <div className="relative z-10 text-center px-6 max-w-2xl mx-auto mb-20 md:mb-32">
          <p className="text-[11px] uppercase tracking-[0.3em] text-white/60 mb-6">Virtual Bridal Studio</p>
          <h1 className="text-xl md:text-2xl lg:text-3xl font-light leading-relaxed mb-8 tracking-wide text-white">
            See the moment before it happens
          </h1>
          <div className="flex flex-row gap-8 justify-center items-center">
            <a href="#for-brides" className="text-[11px] uppercase tracking-[0.2em] text-white border-b border-white/40 pb-1 hover:border-white transition-all">
              Try On
            </a>
            <a href="mailto:developer@codexfoundry.com" className="text-[11px] uppercase tracking-[0.2em] text-white/50 hover:text-white transition-all">
              Contact
            </a>
          </div>
        </div>
      ...
      <section id="about" className="py-32 md:py-40 bg-[#FAFAFA] scroll-mt-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="text-center mb-20">
            <p className="text-[10px] uppercase tracking-[0.3em] text-black/40 mb-6">About</p>
            <h2 className="text-2xl md:text-3xl font-light tracking-wide mb-8 text-black">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-1">
                ...
                <div className="aspect-[3/4] bg-[#F0F0F0] flex items-center justify-center">
                  <div className="text-center">
                    <p className="text-[10px] uppercase tracking-[0.2em] text-black/30">Your Photo</p>
                  </div>
                </div>
                {/* Arrow */}
                <div className="hidden md:flex items-center justify-center bg-[#F0F0F0]">
                  <span className="text-black/20 text-sm tracking-widest">→</span>
                </div>
                {/* After */}
                <div className="aspect-[3/4] bg-[#F0F0F0] overflow-hidden relative group">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-white/95 px-4 py-3">
                    <p className="text-[9px] uppercase tracking-[0.2em] text-black/40">Virtual Try-On</p>
                    <p className="text-[11px] text-black mt-1">Danielle Frankel · Eloise</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div className="space-y-10">
              <p className="text-[10px] uppercase tracking-[0.3em] text-black/40">For Brides</p>
              ...
              >
                <div className="flex justify-between items-start mb-5">
                  <div className="flex items-baseline gap-6">
                    <span className={`text-[10px] tracking-[0.2em] ${bridesStep >= 1 ? 'text-black/60' : 'text-black/30'}`}>01</span>
                    <span className={`text-sm tracking-wide ${bridesStep === 1 ? 'text-black' : 'text-black/40'}`}>Silhouette Analysis</span>
                  </div>
                </div>
                {bridesStep === 1 && (
                  <>
                    <p className="text-[13px] text-black/40 mb-6 ml-12 leading-relaxed">Upload a photo. Our AI analyzes your shape to determine which silhouettes will flatter you most.</p>
                    <button
                      onClick={(e) => { e.stopPropagation(); setBridesStep(2); }}
                      className="ml-12 text-[10px] uppercase tracking-[0.2em] text-black border-b border-black/30 pb-1 hover:border-black transition-all"
                    >
                      Begin
                    </button>
                  </>
              ...
              >
                <div className="flex justify-between items-start mb-5">
                  <div className="flex items-baseline gap-6">
                    <span className={`text-[10px] tracking-[0.2em] ${bridesStep >= 2 ? 'text-black/60' : 'text-black/30'}`}>02</span>
                    <span className={`text-sm tracking-wide ${bridesStep === 2 ? 'text-black' : 'text-black/40'}`}>Select Silhouette</span>
                  </div>
                </div>
                {bridesStep === 2 && (
                  <div className="grid grid-cols-4 gap-2 ml-12">
                    {['A-line', 'Ball Gown', 'Mermaid', 'Sheath'].map((style) => (
                      <button
                        ...
                        className={`py-3 text-center text-[9px] uppercase tracking-[0.15em] transition-all ${
                ...
                {bridesStep > 2 && selectedBridesSilhouette && (
                  <p className="text-[13px] text-black/40 ml-12">{selectedBridesSilhouette}</p>
                )}
              </div>
              ...
              >
                <div className="flex justify-between items-start mb-5">
                  <div className="flex items-baseline gap-6">
                    <span className={`text-[10px] tracking-[0.2em] ${bridesStep >= 3 ? 'text-black/60' : 'text-black/30'}`}>03</span>
                    <span className={`text-sm tracking-wide ${bridesStep === 3 ? 'text-black' : 'text-black/40'}`}>Refine Aesthetic</span>
                  </div>
                </div>
                {bridesStep === 3 && (
                ...
                {bridesStep > 3 && selectedAesthetic && (
                  <p className="text-[13px] text-black/40 ml-12">{selectedAesthetic}</p>
                )}
              </div>
              ...
              >
                <div className="flex justify-between items-start mb-5">
                  <div className="flex items-baseline gap-6">
                    <span className={`text-[10px] tracking-[0.2em] ${bridesStep >= 4 ? 'text-black/60' : 'text-black/30'}`}>04</span>
                    <span className={`text-sm tracking-wide ${bridesStep === 4 ? 'text-black' : 'text-black/40'}`}>Curated Selection</span>
                  </div>
                </div>
                {bridesStep === 4 && (
                  <div className="ml-12">
                    <p className="text-[13px] text-black/40 mb-6 leading-relaxed">Based on your {selectedBridesSilhouette} silhouette and {selectedAesthetic} aesthetic.</p>
                    <div className="flex gap-6">
                      <a
                        href="#browse"
                        className="text-[10px] uppercase tracking-[0.2em] text-black border-b border-black pb-1 hover:border-black/50 transition-all"
                      >
                        View Matches
                      </a>
                      <button
                        onClick={() => { setBridesStep(1); setSelectedBridesSilhouette(null); setSelectedAesthetic(null); }}
                        className="text-[10px] uppercase tracking-[0.2em] text-black/40 hover:text-black transition-all"
                      >
                        Start Over
                      </button>
                    </div>
              ...
              <div className="aspect-[3/4] bg-[#F0F0F0] overflow-hidden relative">
                ...
                {bridesStep === 1 && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    >
                      <p className="text-[10px] uppercase tracking-[0.2em] text-black/40 mb-2">Upload Image</p>
                      <p className="text-[11px] text-black/30">Click to browse</p>
                    </div>
                  </div>
                )}
                {bridesStep === 4 && (
                  <div className="absolute bottom-0 left-0 right-0 bg-white/95 px-5 py-4">
                    <p className="text-[9px] uppercase tracking-[0.2em] text-black/40 mb-1">Your Match</p>
                    <p className="text-[11px] text-black">{selectedBridesSilhouette} · {selectedAesthetic}</p>
                  </div>
                )}
              </div>
              {/* Progress indicator - COS minimal */}
      ...
      <section id="browse" className="py-32 md:py-40 bg-[#FAFAFA] scroll-mt-20">
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          ...
          <div className="text-center mb-16">
            <p className="text-[10px] uppercase tracking-[0.3em] text-black/40 mb-6">Browse</p>
          ...
          {/* Filters - COS minimal style */}
          <div className="overflow-x-auto pb-2 mb-6 -mx-6 px-6 md:overflow-visible md:mx-0 md:px-0">
            <div className="flex gap-6 justify-start md:justify-center min-w-max md:min-w-0">
              {silhouetteFilters.map((filter) => (
                <button
                  key={filter}
                  onClick={() => setSelectedSilhouette(filter)}
                  className={`text-[10px] uppercase tracking-[0.2em] transition-all whitespace-nowrap pb-1 ${
            ...
            <div className="flex gap-6 justify-start md:justify-center min-w-max md:min-w-0">
              {priceFilters.map((price, index) => (
                <button
                  ...
                  className={`text-[10px] uppercase tracking-[0.15em] transition-all whitespace-nowrap pb-1 ${
              ...
              <div key={index} className="group cursor-pointer">
                ...
                <div className="relative aspect-[2/3] bg-[#F0F0F0] overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors duration-300 flex items-end justify-center pb-8">
                    <span className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-[10px] uppercase tracking-[0.2em] text-white">
                      Try On
                    </span>
                  </div>
                </div>
                ...
                <div className="py-4 px-1">
                  <p className="text-[9px] uppercase tracking-[0.2em] text-black/40 mb-1">{dress.designer}</p>
                  <p className="text-[11px] text-black mb-1">{dress.name}</p>
                  <div className="flex items-center gap-2">
                    <span className="text-[11px] text-black">${dress.price.toLocaleString()}</span>
                    <span className="text-[10px] text-black/30 line-through">${dress.originalPrice.toLocaleString()}</span>
                  </div>
                </div>
              </div>
            )) : (
              <div className="col-span-full text-center py-20">
                <p className="text-sm text-black/40 mb-4">No dresses match your filters</p>
                <button
                  onClick={() => { setSelectedSilhouette('All'); setSelectedPriceIndex(0); }}
                  className="text-[10px] uppercase tracking-[0.2em] text-black/40 border-b border-black/20 pb-1 hover:text-black hover:border-black transition-all"
                >
                  Clear filters
                </button>
              </div>
          ...
          {/* View All Button - COS style */}
          <div className="text-center mt-16">
            <a
              href="https://www.stillwhite.com/dresses"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block text-[10px] uppercase tracking-[0.2em] text-black border-b border-black pb-1 hover:border-black/40 transition-all"
            >
              View All Dresses
            </a>
          </div>
      ...
      <section id="boutiques" className="py-32 md:py-40 bg-black scroll-mt-20">
        <div className="max-w-2xl mx-auto px-6 lg:px-12 text-center">
          <p className="text-[10px] uppercase tracking-[0.3em] text-white/40 mb-8">For Boutiques</p>
          <h2 className="text-2xl md:text-3xl font-light tracking-wide mb-8 text-white">
            Empower Your Brides
          </h2>
          ...
          <a href="mailto:developer@codexfoundry.com" className="inline-block text-[10px] uppercase tracking-[0.2em] text-white border-b border-white/40 pb-1 hover:border-white transition-all">
            Partner With Us
          </a>
        </div>
      </section>

      {/* --- MARQUEE SECTION - COS minimal --- */}
      <section className="py-5 bg-white border-t border-black/5 overflow-hidden">
        <div className="relative">
          <div className="flex animate-marquee whitespace-nowrap">
            {[...Array(8)].map((_, i) => (
              <span key={i} className="mx-12 text-[10px] uppercase tracking-[0.3em] text-black/30">
      ...
      <footer className="py-20 bg-white border-t border-black/5">
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          ...
          <div className="border-t border-black/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-black/30 tracking-wide">
            <p>© 2025 Nove</p>
